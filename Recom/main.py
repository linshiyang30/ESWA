...
def load_pretrained_data(args):
    ...
    if args.pretrain == -2:
        pre_model = 'kgat'
    pretrain_path = '../pretrain/%s/%s.npz' % (args.dataset, pre_model)
    # pretrain_path = '../../pretrain/%s.npz' % ( args.dataset)
...
if __name__ == '__main__':
    ...
    """
    *********************************************************
    Load Data from data_generator function. Load the heterogenous graph
    """
    config = dict()
    ...
    """
    *********************************************************
    Use the pretrained data to initialize the embeddings. Load the pretrained embedding.
    """
