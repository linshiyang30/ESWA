...
class input_data(object):
    ...
    def compute_sample_p(self):
        ...
        temp_dir = "../DBLP"  + "/temp/het_random_walk.txt"

        het_walk_f = open(temp_dir, "r")
        centerNode = ''
        neighNode = ''
    ...
    def gen_embeds_w_neigh(self):
        print("Info :generate node neighbor start.")
        ...
        het_neigh_train_f = open("../DBLP/temp/het_neigh_train.txt", "r")
        ...
        print("Info :generate node neighbor done.")
